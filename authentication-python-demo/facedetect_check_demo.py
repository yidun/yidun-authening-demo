...
class TextCheckAPIDemo(object):
    API_URL = "https://verify.dun.163.com/v1/facedetect/check"
    VERSION = "v1"
...
if __name__ == "__main__":
    ...
    params = {
        "picType": "1",
        "picImage": "http://www.xxx.com/xxx.jpg"
    }
    ...
    if code == 200:
        ...
        print("requestId=%s,人脸检测结果:%s,人脸数量:%s,人脸位置信息:%s,具体请参考接口文档说明" %
              (result.get("requestId"), result.get("status"), result.get("faceNumber"), result.get("faceLocations")))
    else:
