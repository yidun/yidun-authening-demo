...
class TextCheckAPIDemo(object):
    API_URL = "https://verify.dun.163.com/v1/facecompare/check"
    VERSION = "v1"
...
if __name__ == "__main__":
    ...
    params = {
        "picType": "1",
        "avatar1": "http://www.xxx.com/xxx.jpg",
        "avatar2": "http://www.xxx.com/xxx.jpg",
        "dataId": "323311889"
    }
    ...
    if code == 200:
        ...
        print("requestId=%s,人脸比对结果:%s,相似度得分:%s,具体请参考接口文档说明" %
              (result.get("requestId"), result.get("matched"), result.get("score")))
    else:
