...
class TextCheckAPIDemo(object):
    API_URL = "https://verify.dun.163.com/v1/facerecognize/check"
    VERSION = "v1"
...
if __name__ == "__main__":
    ...
    if code == 200:
        ...
        print("requestId=%s,人脸检索结果:%s,相似度得分:%s,匹配人脸数据:%s,具体请参考接口文档说明" %
              (result.get("requestId"), result.get("matched"), result.get("score"), result.get("matchedFaces")))
    else:
