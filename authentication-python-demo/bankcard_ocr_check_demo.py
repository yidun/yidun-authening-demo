...
class TextCheckAPIDemo(object):
    API_URL = "https://verify.dun.163.com/v1/ocr/bankcard"
    VERSION = "v1"
...
if __name__ == "__main__":
    ...
    if code == 200:
        ...
        print("taskId=%s,银行卡OCR识别结果:%s,识别数据:%s,具体请参考接口文档说明" %
              (result.get("taskId"), result.get("status"), result.get("ocrResponseDetail")))
    else:
