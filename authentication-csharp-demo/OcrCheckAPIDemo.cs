...
namespace Com.Netease.Is.Authentication.Demo
{
    class OcrCheckAPIDemo
    {
        public static void test()
        {
            ...
            /** 验证接口地址 */
            String apiUrl = "https://verify.dun.163.com/v1/ocr/check";
            ...
            parameters.Add("frontPicture", "http://123.jpg");
            parameters.Add("backPicture", "http://123.jpg");
