...
namespace Com.Netease.Is.Authentication.Demo
{
    class BankCardCheckAPIDemo
    {
        public static void test()
        {
            ...
            /** 验证接口地址 */
            String apiUrl = "https://verify.dun.163.com/v1/bankcard/check";
            ...
            parameters.Add("idCardNo", "341622123456784317");
            parameters.Add("bankCardNo", "6222123412343569");
            parameters.Add("phone", "13358123456");
