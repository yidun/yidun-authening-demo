...
public class OcrCheckAPIDemo {
     ...
     * 接口地址
     */
    private final static String API_URL = "https://verify.dun.163.com/v1/ocr/check";
    /**
    ...
    public static void main(String[] args) throws Exception {
        ...
        params.put("frontPicture", "https://123.jpg");
        params.put("backPicture", "https://234.jpg");
        ...
        if (code == 200) {
            ...
            if (status == 1) {
                ...
                System.out.printf("taskId=%s，上传图片为非身份证图片或解析失败%n", taskId);
            } else {
