 ...
 * @author yidun
 */
public class VideoLivePersonAuditAPIDemo {
    /**
     * 产品密钥ID，产品标识
     */
     ...
     * 接口地址
     */
    private final static String API_URL = "https://verify.dun.163yun.com/v1/liveperson/h5/audit";
    /**
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (code == 200) {
            ...
            System.out.printf("taskId=%s，在线认证结果：%s, 原因：%s,具体参见接口文档说明%n", taskId,status,  reasonType);
        } else {
