 ...
 * @author yidun
 */
public class Mobile2CheckAPIDemo {
    /**
     * 产品密钥ID，产品标识
     */
     ...
     * 接口地址
     */
    private final static String API_URL = "https://verify.dun.163yun.com/v1/mobile2Ele/check";
    /**
