...
const (
	apiURL     = "https://verify.dun.163.com/v1/facecompare/check"
	version    = "v1"
...
func main() {
	params := url.Values{
		"picType": []string{"1"},
		"avatar1": []string{"http://123.jpg"},
		"avatar2": []string{"http://123.jpg"},
		"dataId":  []string{"323311889"},
	}
	...
	if code == 200 {
		...
		fmt.Printf("requestId=%s,人脸比对结果:%s,相似度得分:%s, 具体请参考接口文档说明\n", requestId, matched, score)
	} else {
