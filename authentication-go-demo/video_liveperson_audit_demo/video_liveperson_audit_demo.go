...
const (
	apiURL     = "https://verify.dun.163.com/v1/liveperson/h5/audit"
	version    = "v1"
...
func main() {
	...
	if code == 200 {
		...
		fmt.Printf("taskId=%s,认证结果:%s,原因详情:%s,图片类型:%s,抓取头像照片:%s,公安是否比对通过:%s,相似度得分:%s, 具体请参考接口文档说明\n", taskId, status, reasonType, avatar, faceMatched, similarityScore)
	} else {
