/**
 * 人脸注册接口示例代码
 * 接口文档: https://support.dun.163.com/documents/391676076156063744?docId=466328480154943488
 */
package main
...
const (
	apiURL     = "https://verify.dun.163.com/v1/facerecg/addFace"
	version    = "v1"
...
func main() {
	...
	if code == 200 {
		...
		fmt.Printf("人脸注册结果:%s,具体请参考接口文档说明\n", status)
	} else {
