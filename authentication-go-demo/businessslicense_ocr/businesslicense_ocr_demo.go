/**
 * 营业执照ocr接口示例代码
 * 接口文档: https://support.dun.163.com/documents/391676076156063744?docId=492521577992761344
 */
package main
...
const (
	apiURL     = "https://verify.dun.163.com/v1/ocr/business_license"
	version    = "v1"
...
func main() {
	params := url.Values{
		"image": []string{"imageBase64 string"},
	}
	...
	if code == 200 {
		...
		ocrResponseDetail, _ := ret.Get("result").Get("ocrResponseDetail").MarshalJSON()
		fmt.Printf("taskId=%s,营业执照OCR识别结果:%s,识别数据:%s, 具体请参考接口文档说明\n", taskId, status, ocrResponseDetail)
	} else {
