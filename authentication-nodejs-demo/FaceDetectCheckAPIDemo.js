...
// 易盾反垃圾云服务直播流信息提交接口地址 
var apiurl = "https://verify.dun.163.com/v1/facedetect/check";
//请求参数
var post_data = {
	// 1.设置公有有参数
	secretId: secretId,
...
var responseCallback = function (responseData) {
	...
	if (code == 200) {
		...
		console.log("requestId=%s,人脸检测结果:%s,人脸数量:%s,人脸位置信息:%s,具体请参考接口文档说明",result.requestId,result.status,result.faceNumber,result.faceLocations);
	} else {
