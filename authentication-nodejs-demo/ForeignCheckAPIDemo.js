...
// 易盾信息认证服务出入境证件核验提交接口地址
var apiurl = "https://verify.dun.163.com/v1/foreign/check";
//请求参数
var post_data = {
	// 1.设置公有有参数
	secretId: secretId,
...
var responseCallback = function (responseData) {
	...
	if (code == 200) {
		...
		console.log("taskId =%s, 出入境证件核验结果:%s, 原因详情:%s, 具体请参考接口文档说明",result.taskId,result.status,result.reasonType);
	} else {
