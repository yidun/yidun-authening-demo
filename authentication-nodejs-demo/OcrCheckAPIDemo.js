...
// 易盾反垃圾云服务直播流信息提交接口地址 
var apiurl = "https://verify.dun.163.com/v1/ocr/check";
//请求参数
var post_data = {
	// 1.设置公有有参数
	secretId: secretId,
...
var responseCallback = function (responseData) {
	...
	if (code == 200) {
		...
		console.log("taskId=%s,身份证OCR识别结果:%s,识别数据:%s,具体请参考接口文档说明",result.taskId,result.status,result.ocrResponseDetail);
	} else {
